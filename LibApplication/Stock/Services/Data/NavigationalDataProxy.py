...
# SKIP = ["__class__", "__init__", "__new__", "__dict__", "_set_state"]
...
#                 print("got {0}".format(obj))
#                 attr = getattr(obj, member)
#                 print("got {0}.{1}".format(obj, member))
#                 print(attr)
#                 # if(callable(attr)):
#                 #     def wrapper(*args, **kwargs):
#                 #         func = getattr(base, member)
...
#             properies[member] = property(get_wrapper)

#     def init(self):
#         pass

#     properies["__init__"] = init
#     properies["__isnavproxy__"] = True
...
class NavigationalDataProxy(LazyLoadProxy):

    def __init__(self, obj_id, data_service, base):
        super(NavigationalDataProxy, self).__init__(lambda: data_service.read_object(obj_id))